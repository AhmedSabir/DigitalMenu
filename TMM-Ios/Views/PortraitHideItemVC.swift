...
class PortraitHideItemVC: UIViewController,UITableViewDelegate,UITableViewDataSource,UIGestureRecognizerDelegate {
    ...
    override func viewDidLoad() {
        ...
        else
        {
            ...
            self.btnSave.titleLabel?.textColor  = color1
            self.btnClear.titleLabel?.textColor = UIColor.black
    ...
    func downloadThemes(ThemeID: Int32)
    {
        ...
        SkopelosClient.shared.read { context in
            ...
            if (str == nil || str!.isEmpty)
            {
                ...
                self.btnClear.setTitleColor(UIColor.black, for: .normal)
            }
            else
            {
            ...
            DispatchQueue.main.async {
                ...
                else
                {
                    ...
                    if let jsonObj = try? JSONSerialization.jsonObject(with: data!, options: .allowFragments) as? NSDictionary {
                        ...
                        //printing the json in console
                        print(jsonObj?.value(forKey: "dtItems")! as Any)
